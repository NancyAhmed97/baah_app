...
const ChangePasswordScreen = () => {
  ...
  const handleChangePassword = async () => {
    ...
    if (newPassword === confirmPassword) {
      const response = await axios.post(`https://marriage-application.onrender.com/changepassword?id=${userinfo.user.userArray.id}&new_password=${newPassword}&old_password=${currentPassword}`);
